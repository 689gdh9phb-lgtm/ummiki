...
const prophetsScripturesQuestions: Question[] = [
  ...
  },
  {
    ...
    options: ['Он написан на скрижалях', 'В нём не изменилась ни одна буква, и Аллах взял на Себя его сохранение', 'Он ниспослан на языке ‘ибран'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['Забур и Коран', 'Таврат и Инджиль', 'Свитки Шиса'],
    correctAnswer: 1,
